...
# Bulk data folder
BULK_ROOT = '/tudelft.net/staff-bulk/ewi/insy/CYS/spicek/jrijsdijk/rl-paper/ASCAD_F/cm_experiment_hw/'
...
MODEL_LAYERS = [
    tf.keras.layers.Conv1D(16, 100, kernel_initializer='he_uniform', activation='selu', padding='same'),
