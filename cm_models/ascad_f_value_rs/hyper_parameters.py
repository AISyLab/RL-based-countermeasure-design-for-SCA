...
# This rewards networks smaller than current state of the art
MAX_TRAINABLE_PARAMS_FOR_REWARD = 16960


# Bulk data folder
BULK_ROOT = '/tudelft.net/staff-bulk/ewi/insy/CYS/spicek/jrijsdijk/rl-paper/ASCAD_F/cm_experiment_value_rs/'
...
MODEL_LAYERS = [
    tf.keras.layers.Conv1D(2, 75, kernel_initializer='he_uniform', activation='selu', padding='same'),
    tf.keras.layers.AveragePooling1D(25, strides=25),
    tf.keras.layers.Conv1D(2, 3, kernel_initializer='he_uniform', activation='selu', padding='same'),
    tf.keras.layers.BatchNormalization(),
    tf.keras.layers.AveragePooling1D(4, strides=4),
    tf.keras.layers.Conv1D(8, 2, kernel_initializer='he_uniform', activation='selu', padding='same'),
