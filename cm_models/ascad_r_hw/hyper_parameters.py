...
# Bulk data folder
BULK_ROOT = '/tudelft.net/staff-bulk/ewi/insy/CYS/spicek/jrijsdijk/rl-paper/ASCAD_R/cm_experiment_hw/'
...
MODEL_LAYERS = [
    tf.keras.layers.Conv1D(8, 3, kernel_initializer='he_uniform', activation='selu', padding='same'),
