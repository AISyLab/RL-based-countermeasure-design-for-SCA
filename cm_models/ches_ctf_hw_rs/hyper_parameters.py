...
# Bulk data folder
BULK_ROOT = '/tudelft.net/staff-bulk/ewi/insy/CYS/spicek/jrijsdijk/rl-paper/CHES_CTF/cm_experiment_hw_rs/'
...
MODEL_LAYERS = [
    tf.keras.layers.Conv1D(2, 2, kernel_initializer='he_uniform', activation='selu', padding='same'),
    tf.keras.layers.AveragePooling1D(7, strides=7),
